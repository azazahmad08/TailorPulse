...
const SideBar = () => {
  ...
  return (
    <div>
      <aside className="fixed flex flex-col w-64 min-h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
